...
--epochs 500 \
--eval 0 \
--save_name pdebench_1d_advection_beta1e0_1024_10_10_Factformer
# Burgers数据集
python run.py \
--gpu 0 \
...
--epochs 500 \
--eval 0 \
--save_name pdebench_1d_burgers_nu0001_1024_10_10_Factformer
...
--epochs 500 \
--eval 0 \
--save_name pdebench_1d_cfd_eta001_zeta001_1024_10_10_Factformer
...
--epochs 500 \
--eval 0 \
--save_name pdebench_1d_reacdiff_nu05_rho10_1024_10_10_Factformer
...
--epochs 500 \
--eval 0 \
--save_name pdebench_1d_diffsorp_na_na_1024_10_10_Factformer
